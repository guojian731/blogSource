...
![jvm装载步骤](rabbitmq-7-设置集群/rabbitmq2.png)
...
在日志中可以看到我们的节点名称、home路径、日志路径等。我们根据home路径可知，.erlang.cookie文件就在root下。
...
因为rabbitmq的hostname不能是系统默认的，所以我们在做集群之前需要先改一下hostname。
...
![jvm装载步骤](rabbitmq-7-设置集群/rabbitmq12.png)
